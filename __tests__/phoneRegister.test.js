...
describe('Testing getPersonNumberByType',()=>{
    ...
    const testValues = [
        ...
        test.each(testValues)('%s, %s, %s returns %s', (fn, ln, type, expectedResult) => {
    ...
    describe('Test 5: testing empty string as type using modified data',()=>{
      ...
      test('Test firstname:Leila, lastname:Hökki and type "" ',()=>{
        ...
        expect(modifiedregister.getPersonNumbersByType('Leila','Hökki','')).toEqual(['87654421'])
      })
    })
  ...
  describe('Testing with modified data',()=>{
    ...
    test('Testing type " "',()=>{
      const register= new PhoneRegister(testData);
      const expectedResult = [
        {"firstname": "Leila", "lastname":"Hökki","number":{"type":"","tel":"87654421"}}
      ];
